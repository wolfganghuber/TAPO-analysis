...
```{r}
writeLines(sprintf("file '%s'", videos$fast), con = "concat.txt")
```
...
```{r}
system2("/opt/homebrew/bin/ffmpeg", args = paste("-f concat -i concat.txt -c copy", file.path(fastmoviesdir, "concat.mp4")))
```
